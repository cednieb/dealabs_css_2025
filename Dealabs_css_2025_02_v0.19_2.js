...
, [ ["3060","4060","3050","4050","4070","ryzen",["ryzen","ai"],"vega",["mini","pc"]],"#9bc899","keywords"]  
          ...
          if ( myWordListTemp[i][2] == "keywords-exclude1" || myWordListTemp[i][2] == "keywords-exclude" )   
             ...
             for ( j=0; j<myWordListTemp[i][3].length; j++ ) 
                 ...
                 if ( myWordListTemp[i][2] == "keywords-exclude1" ) 
                    if ( j > 0 )
                        myCssTemp += '\n,';                          
                 // A faire, faire la difference entre un mot et un groupe de mots  // instanceof Array === false
