...
var mycss1_not_main_discussion =` div:has(>section):has(#tour-filter) { display:none; } `; // #discussionHeaderPortal  .thread--discussion  .threadGrid-headerMeta  .threadGrid-footerMeta
...
var myWordListTest  = [  [[9,28,32,61,215,217,304,306,1207,1586,1588,1590,1591,2157,2193],"#ffa500","merchant-id"]                        
                       ...
                       , [[["45","converse","chuck"],["savon"],["bot","coque"],["coffret","seigneur"],"corsair"],"#ff55ff","keywords"]    
                       
                       , [4,"#9bc848","merchant-id"]                        
                       , [["3764"] ,"#9bc848","merchant-id"] 
                       , [["195","66"] ,"#9bc848","merchant-id"] 
                       
                      ];  

     
// , [["converse","chuck"],"#5fcdf5","keywords-exclude","45"]
// , [[["45","converse","chuck"],["savon"],["bot","coque"],["coffret","seigneur"],"corsair"],"#ff55ff","keywords"] 
...
if ( myWordListTemp.length > 0 )
   ...
   for ( i=0; i<myWordListTemp.length; i++ )
       ...
       //////////////////////////////// selectors adult et keywords ////////////////////////////////     
       if ( myWordListTemp[i][2] == "adult" || myWordListTemp[i][2] == "keywords" )
          {   
          if ( myWordListTemp[i][0] instanceof Array === false ) 
             {   
             myCssTemp += 'a[title*="' +myWordListTemp[i][0]+'" i] , a[href*="'+myWordListTemp[i][0]+'" i] \n'; 
             }      
          else 
              for ( j=0; j<myWordListTemp[i][0].length; j++ ) 
                  { 
...
//////////////////////////////// selector keywords-exclude //////////////////////////////// 
//           if ( myWordListTemp[i][2] == "keywords-exclude" )

              
       
//////////////////////////////// ajout du css ////////////////////////////////  
       if ( myWordListTemp[i][2] == "merchant-id" || myWordListTemp[i][2] == "keywords" || myWordListTemp[i][2] == "keywords-exclude" )
          {
          ...
          if ( myWordListTemp[i].length  >= 4 && myWordListTemp[i][2] != "keywords-exclude" )  
             {
...
but: filtre pour mot ou groupe de mots, statut ok.
     filtre pour mot ou groupe de mots en ignorant certains termes, statut todo.
...
var myFeeds  = [  [["granblue","logitech","pebble",["imprimante","3d"],["papier","toilette"],"tapo",["mini","pc"],"redmi","eneloop","lessive",["imprimante","laser"]
                  ...
                  ,["disque","dur"],["humble","bundle","choice"] ],"#9bc848","keywords-color"]  ];   
*/  

/*
var myFeeds  = [  
                   [["ssd","granblue","logitech","pebble",["imprimante","3d"],["papier","toilette"],"tapo",["mini","pc"],"redmi","eneloop","lessive",["imprimante","laser"]
                  ,["arctic","f8","pwm","pst"],["pwm","pst"],["prime","gaming"],"dove",["vélos","électriques"],"chromebook","cafetière","songmics","vasagle"
                  ,["disque","dur"],["humble","bundle","choice"]] ,"#5fcdf5","keywords-color","#000000"]   
                  , [[ ["ssd","apple"],["ssd","portable"],["ssd","nvme"] ],"#aaaaaa","keywords-color"]  // ,["ssd",""] 
               ];  
